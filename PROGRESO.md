...
| 6b. Dominio daily-charter.com | 🔶 CASI — DNS viva y verificada (www CNAME + 4 A en apex, autoritativo OK; Resend Verified con SPF/DKIM resolviendo). http://www → 200, apex → 301 a www. FALTA: certificado HTTPS de GitHub (en emisión; monitor activo que activará Enforce HTTPS al emitirse) |
